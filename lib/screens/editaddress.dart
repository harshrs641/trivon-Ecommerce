...
class EditAddressPage extends StatefulWidget {
  var address;
  int index;
  EditAddressPage(this.address, this.index);
  @override
  _EditAddressPageState createState() => _EditAddressPageState(address, index);
}

class _EditAddressPageState extends State<EditAddressPage> {
  var address;
  int index;
  _EditAddressPageState(this.address, this.index);
  ...
  void initState() {
    ...
    address1.text = address['street'];
    address2.text = address['landmark'];
    address3.text = address['area'];
    address4.text = address['pincode'];
    phone.text = address['phone'];
    tempName = address['name'];
    tempAdd1 = address['street'];
    tempAdd2 = address['landmark'];
    tempAdd3 = address['area'];
    tempAdd4 = address['pincode'];
    tempPhone = address['phone'];

    if (address['alter'] != null) {
      phoneAlter.text = address['alterphone'];
      tempAlter = address['alterphone'];
    }
  ...
  void submit() async {
    if (tempName == '' ||
      ...
      var allAddress = await Firestore.instance
